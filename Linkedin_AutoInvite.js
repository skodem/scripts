...
if (loc[1].toLowerCase() === 'mynetwork' && loc[2].toLowerCase() === '') {
    ...
    var repSec = 0.5; // The speed of checking one profile in seconds, you can INCREAE this value a little if you have a low Internet speed.    document.querySelector("ul.artdeco-card.mb4").style.display = "none";
